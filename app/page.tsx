    ...
    <main className="min-h-screen bg-stone-50 flex flex-col items-center justify-center px-6">
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="space-y-3 pt-4">
          <a href="/post" className="block w-full bg-stone-800 text-white py-4 px-6 rounded-2xl text-base font-medium hover:bg-stone-700 transition-colors">
            I need to talk
          </a>
          <a href="/browse" className="block w-full border border-stone-300 text-stone-700 py-4 px-6 rounded-2xl text-base font-medium hover:bg-stone-100 transition-colors">
            I want to help
          </a>
        </div>
